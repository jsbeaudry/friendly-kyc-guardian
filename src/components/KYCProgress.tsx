  ...
  return (
    <div className="w-full py-4">
      <div className="relative flex justify-between">
        ...
        <div 
          className="absolute top-4 left-0 h-0.5 bg-kyc-success transition-all duration-500 ease-in-out"
          style={{
        ...
        {steps.map((step, index) => (
          <div key={index} className="relative flex flex-col items-center group">
            ...
            {step.current && (
              <div className="absolute -bottom-8 w-max opacity-0 group-hover:opacity-100 transition-opacity duration-300">
